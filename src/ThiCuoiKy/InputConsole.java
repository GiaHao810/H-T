...
public class InputConsole {
    ...
    public HangHoa suaHang() throws ParseException{
        HangHoa hanghoa = new HangHoa(){};
        ...
        switch(userKey){
            case 1:
                ...
                HangHoa hanghoaThem = new HangThucPham(null, tenHang, soLuongTon, donGia, sDF.parse(ngaySX), sDF.parse(ngayHH), nhaCungCap);
                hanghoa = hanghoaThem;
                break;
            case 2:
                System.out.print("Thoi gian bao hanh (Thang): ");
                ...
                HangHoa hanghoaThem_1 = new HangDienMay(null, tenHang, soLuongTon, donGia, tGbaoHanh, congSuat);
                hanghoa = hanghoaThem_1;
                break;
            case 3:
                System.out.print("Nha san xuat: ");
                ...
                HangHoa hanghoaThem_2 = new HangSanhSu(null, tenHang, soLuongTon, donGia, nhaSX, sDF.parse(ngayNhapKho));
                hanghoa = hanghoaThem_2;
                break;
        }
    return hanghoa;
